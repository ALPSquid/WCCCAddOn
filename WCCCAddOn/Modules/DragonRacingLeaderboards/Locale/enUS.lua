...
L["NPC_TIMEKEEPER"] = {"Bronze Timekeeper"}
L["NPC_TIMEKEEPER_ASSISTANT"] = {"Bronze Timekeeper Assistant"}
...
L["ASSISTANT_TIME_PATTERN_0"] = "this course[%D]+(%d+%.%d+)"
L["ASSISTANT_TIME_PATTERN_1"] = "advanced[%D]+(%d+%.%d+)"
L["ASSISTANT_TIME_PATTERN_2"] = "reverse[%D]+(%d+%.%d+)"
